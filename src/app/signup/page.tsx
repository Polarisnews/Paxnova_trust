...
export default async function SignUpPage() {
  ...
  return (
    <div className="relative mx-auto flex min-h-[calc(100dvh-4rem)] max-w-7xl flex-col items-stretch gap-10 px-4 py-16 sm:px-6 lg:flex-row lg:gap-16 lg:px-8 lg:py-24">
      <aside className="hidden w-full max-w-sm flex-col justify-between rounded-2xl bg-navy-900 p-8 text-white shadow-elev lg:flex">
        <div>
          ...
          <h1 className="mt-4 font-display text-4xl font-semibold leading-tight tracking-tight">
            Open a Paxnova Trust account in minutes.
          </h1>
      ...
      <div className="w-full flex-1">
        <div className="rounded-2xl border border-border bg-card p-8 shadow-elev">
          <h2 className="font-display text-2xl font-semibold tracking-tight">
            Open a Paxnova Trust account
          </h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Takes about 5 minutes. Federal law requires us to collect a few
            things to verify your identity before we open your account.
          </p>
